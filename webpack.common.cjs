...
module.exports = {
    ...
    plugins: [
        new CopyPlugin({
            patterns: [
                { from: path.resolve(extensionFolder, 'language-binge.css'), to: distFolder },
                { from: path.resolve(extensionFolder, 'manifest.json'), to: distFolder },
                ...
                { from: path.resolve(extensionFolder, 'typography.png'), to: distFolder },
